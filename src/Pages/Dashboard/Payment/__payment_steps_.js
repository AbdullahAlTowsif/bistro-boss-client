 ...
 * install stripe on the server side and get client secret. make sure you use the payment mehthod types: ['card']
 * 6. from client side get the client secret and save it.
 * 7. use confirm card payment and pass user detail information, card and client secret
